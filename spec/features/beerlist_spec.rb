...
describe "Beerlist page" do
  ...
  it "shows beers default in alpabetical order by name", js:true do
    visit beerlist_path
    save_and_open_page
  ...
  it "when user clicks 'style', beers are ordered according to style", js:true do
    visit beerlist_path
    click_link "style"
    save_and_open_page
  ...
  it "when user clicks 'brewery', beers are ordered according to brewery", js:true do
    visit beerlist_path
    click_link "brewery"
